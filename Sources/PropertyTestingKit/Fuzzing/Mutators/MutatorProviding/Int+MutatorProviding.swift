...
/// Concrete mutator for Int values - avoids closure boxing overhead.
public struct IntMutator: Mutator, Sendable {
    ...
    public func mutate(_ value: Int) -> [Int] {
...
extension Int: MutatorProviding {
    public static let defaultMutator = IntMutator()
}
