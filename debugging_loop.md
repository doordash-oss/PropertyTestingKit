...
1. Look in DEBUGGING_PROGRESS.md if it exists. If it doesn't exist, create it. If it's missing any information you already have about the problem at hand, amend that.
...
3. When you feel you've learned something new, update DEBUGGING_PROGRESS.md. Discuss what worked and what didn't work.
